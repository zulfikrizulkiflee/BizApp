...
--></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="search_box">
                                <input class="search-box" type="text" placeholder="Click Here to Find Product..." style="border:1px solid #29ABE2 !important;" /> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items" id="disc">
                            <!--features_items-->
                            <h2 class="title text-center focus-here" tabindex="1">Discover Items</h2>
                            <div class="row filter-items">
                                <div class="col-sm-5" style="float:left">
                                    Sort By:
                                    <div class="btn-group">
                                        <button type="button" id="1" class="btn btn-default menu-button-search dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Relevance</button>

                                        <ul class="dropdown-menu sort-menu search-menu">
                            ...
                            <div class="row filter-items-cat">
                                <div class="col-sm-5" style="float:left">
                                    Sort By:
                                    <div class="btn-group">
                                        <button type="button" id="1" class="btn btn-default menu-button-cat dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Relevance</button>

                                        <ul class="dropdown-menu sort-menu cat-menu">
                                            <li id="1"><a href="javascript:void(0)">Relevance</a></li>
                                            <li id="2"><a href="javascript:void(0)">Price: High to low</a></li>
                                            <li id="3"><a href="javascript:void(0)">Price: Low to high</a></li>
                                        </ul>
                        ...
                        <div class='title text-center'>
                            <a href='#disc' onclick='discoverProduct();'>
                                <button type="button" class="btn btn-default get" style='margin-top:0;margin-bottom: 20px;'>Discover More</button>
                            </a>
                        </div>
                        <!--features_items-->
                    </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                var id_menu_search = $(".menu-button-search").attr("id");

                $(".search-menu li").on("click", function () {
                    var menutext = $(this).text();
                    id_menu_search = $(this).attr("id");
                    $(".menu-button-search").text(menutext);
                    $(".menu-button-search").attr("id", id_menu_search);
                    searchFunc();
                });
                ...
                $(".search-box").on('keyup', function (e) {
                    ...
                    if (e.keyCode == 13) {
                        if (userSearch != null) {
                            ...
                            $('.filter-items-cat').css('display', 'none');
                        }
                    }
                });
            ...
            function discoverProduct() {
                ...
                $(".filter-items-cat").css("display", "none");
                $.get("discover.php", function (data) {
                    $("img.lazy").lazyload();
                    $(".discover-items").html(data);
                });
            }
